...
export function getAddressTransactionList(address, params = {}) {
    return instance.get(`addresses/${address}/transactions`, {params})
...
export function getBalance(addressHash) {
    return instance.get('addresses/' + addressHash + '?with_sum=true')
        .then((response) => {
...
export function getAddressStakeList(address) {
    return instance.get(`addresses/${address}/delegations`, {params: {limit: 999}})
        .then((response) => response.data);
}
